...
def get_args():
    ...
    # BSPM
    parser.add_argument('--sharp_solv', type=str)
    parser.add_argument('--sharp_step', type=int)
    parser.add_argument('--sharp_time', type=float)
    parser.add_argument('--ideal_cutoff', type=int)
    parser.add_argument('--ideal_weight', type=float)
    parser.add_argument('--early_merge', type=int, help='0: False, 1: True')
    parser.add_argument('--point_combi', type=int, help='0: False, 1: True')
    parser.add_argument('--sharp_off', type=int, help='0: False, 1: True')
